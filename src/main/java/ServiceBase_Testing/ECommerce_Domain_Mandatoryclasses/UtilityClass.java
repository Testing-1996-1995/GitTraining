...
public class UtilityClass {
	...
	{
		 FileInputStream file1= new FileInputStream("C:\\Users\\User\\eclipse new\\ECommerce_Domain\\TestData\\parameteristiondata.xlsx");
	...
	public static void ScreenShot(WebDriver driver,String Snap) throws IOException
	{
		...
		File dest= new File("C:\\Users\\User\\eclipse new\\ECommerce_Domain\\Screenshots/"+Snap+".jpg");
